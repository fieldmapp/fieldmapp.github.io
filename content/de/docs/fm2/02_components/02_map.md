...
In diesem Beispiel wird ein Vektordatensatz (`elbe_basin.geojson`) bearbeitet und gespeichert.
...
<video width="640" height="480" controls>
  <source src="/assets/video/fm_gis_module_edt.mp4" type="video/mp4">
</video>
...
-  siehe Anleitung *Geodaten visualiseren*
...
In diesem Beispiel werden neue Feature-Geometrien digitalisiert und in einem vorhandenen Datensatz (`elbe_basin.geojson`) gespeichert. 
...
<video width="640" height="480" controls>
  <source src="/assets/video/fm_gis_new_feature.mp4" type="video/mp4">
</video>
...
<video width="640" height="480" controls>
  <source src="/assets/video/gis_follow_pos.mp4" type="video/mp4">
</video>
...
<video width="640" height="480" controls>
  <source src="/assets/video/gis_search.mp4" type="video/mp4">
</video>
